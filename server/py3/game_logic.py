...
class TicTacToeLogic(GameLogic):
    ...
    def __init__(self, board_size=(3, 3)):
        ...
        self.board_size = board_size if board_size else (3, 3)

    def get_default_board(self) -> list:
        """Get mxn empty board."""
        return [[None] * self.board_size[0] for _ in range(self.board_size[1])]
...
class ConnectFourLogic(GameLogic):
    ...
    def __init__(self, board_size=(6, 7)):
        ...
        self.board_size = board_size if board_size else (6, 7)
...
# Game logic factory
def get_game_logic(game_type: str, board_size=None) -> GameLogic:
    """Get game logic instance for the given game type."""
    if game_type == 'tic_tac_toe':
        return TicTacToeLogic(board_size=board_size)
    elif game_type == 'connect_four':
        return ConnectFourLogic(grid_size=board_size)
